...
own_id= 1463561538
tele_bot='6565939071:AAExY3JYAKhayJO05X4Yu1CVna_8R1uaz7c'
ch='qwertyuioplkjhgfdsazxcvbnm'
def create():
 global created
 global failed
 user=str(random.choice('qwertyuioplkjhgfdsazxcvbnmm')[0])+str(''.join(random.choice(ch) for i in range(7)))
